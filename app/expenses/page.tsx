...
import { ExpenseByCategorySummary, fetchExpense } from '@/state/apiService';
...
const Expenses = () => {
    const [data, setData] = useState<ExpenseByCategorySummary[] | null>(null);
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const dashboardData = await fetchExpense();
